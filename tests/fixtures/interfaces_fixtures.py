...
from src.infrastructure.interfaces_impl.marburg_parsers_impl.marburg_erlenring_parser_interface_impl import MarburgErlenringParserInterfaceImpl
from src.infrastructure.interfaces_impl.marburg_parsers_impl.marburg_cafeteria_parser_interface_impl import MarburgCafeteriaParserInterfaceImpl
from src.infrastructure.interfaces_impl.marburg_parsers_impl.marburg_lahnberge_parser_interface_impl import MarburgLahnbergeParserInterfaceImpl
from src.infrastructure.interfaces_impl.marburg_parsers_impl.marburg_mo_diner_parser_interface_impl import MarburgMoDinerParserInterfaceImpl

from src.infrastructure.interfaces_impl.giessen_parsers_impl.giessen_thm_parser_interface_impl import GiessenTHMParserInterfaceImpl
