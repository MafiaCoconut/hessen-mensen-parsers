...
class TestCanteensMenu:
    ...
    def test_get_menu_after_closing(canteen_service, certain_canteens_menu):
        ...
        for language in languages:
            menu = canteen_service.get_canteens_data(canteen_id=canteen_id, locale=language, test_time=9999, test_day=3)
            print(menu)
    ...
    def test_get_menu_in_open_time(canteen_service, certain_canteens_menu):
        ...
        for language in languages:
            menu = canteen_service.get_canteens_data(canteen_id=canteen_id, locale=language,
